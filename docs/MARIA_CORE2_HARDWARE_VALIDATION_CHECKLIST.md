...
| ----------------------- | ------------------------------------------------------------------------- | ------------------------------------------------- | ---------- | -------------------------------------------------- | -------------------------------------------- |
| USB serial detection    | Core2 appears as `/dev/cu.usbserial-*` or equivalent, not debug/Bluetooth | `/dev/cu.usbserial-537A0079331` detected          | Pass       | `pio device list` output                           | First flash used VID:PID `1A86:55D4`         |
